...
BUILTIN_TOOL_CATALOG: list[dict[str, str]] = [
    ...
    {"id": "omnidoer_vault_create", "description": "Create the configured OmniDoer vault with the configured passphrase file; YOLO Mode only."},
    ...
    {"id": "omnidoer_request_approve", "description": "Approve an OmniDoer Control Client request; YOLO Mode only."},
    ...
    {"id": "omnidoer_chat_run_next", "description": "Run OmniDoer's one-shot chat runner for the next queued message; YOLO Mode only."},
    {"id": "omnidoer_doctor", "description": "Run OmniDoer runtime readiness diagnostics."},
    {"id": "omnidoer_control_status", "description": "Inspect OmniDoer Control Client service status."},
    {"id": "omnidoer_control_devices", "description": "List paired OmniDoer Control Client devices."},
    {"id": "omnidoer_control_sessions", "description": "List active OmniDoer Control Client sessions."},
    {"id": "omnidoer_control_tunnel_info", "description": "Show OmniDoer Control Client tunnel connection metadata."},
    {"id": "omnidoer_control_security_status", "description": "Show OmniDoer Control Client security status."},
    {"id": "omnidoer_control_sync_status", "description": "Inspect OmniDoer Codex thread/session sync status."},
    {"id": "omnidoer_control_revoke_device", "description": "Revoke a paired OmniDoer Control Client device; YOLO Mode only."},
    {"id": "omnidoer_control_revoke_session", "description": "Revoke an OmniDoer Control Client session; YOLO Mode only."},
    {"id": "omnidoer_control_enable_sync", "description": "Enable OmniDoer Control Client sync for a reviewed session; YOLO Mode only."},
    {"id": "omnidoer_request_challenge", "description": "Challenge an OmniDoer Control Client request; YOLO Mode only."},
    {"id": "omnidoer_request_takeover", "description": "Take over an OmniDoer Control Client request; YOLO Mode only."},
    {"id": "omnidoer_request_release", "description": "Release an OmniDoer Control Client request; YOLO Mode only."},
    {"id": "omnidoer_audit_tail", "description": "Read recent OmniDoer audit log entries."},
    {"id": "omnidoer_audit_verify", "description": "Verify OmniDoer audit log integrity."},
    {"id": "omnidoer_policy_test", "description": "Run OmniDoer policy self-tests."},
    {"id": "omnidoer_telegram_status", "description": "Inspect OmniDoer Telegram notification bridge status."},
    {"id": "omnidoer_console_dry_run", "description": "Preview OmniDoer's Codex console wrapper command without launching Codex."},
    {"id": "omnidoer_upgrade_dry_run", "description": "Preview OmniDoer upgrade actions without installing files."},
    {"id": "omnidoer_mcp_self_test", "description": "Run OmniDoer's MCP server self-test without starting a persistent server."},
    {"id": "omnidoer_heartbeat_status", "description": "Inspect OmniDoer Control Client heartbeat scheduler status."},
    {"id": "omnidoer_heartbeat_tasks", "description": "List OmniDoer Control Client heartbeat scheduler tasks."},
    {"id": "omnidoer_heartbeat_add_task", "description": "Add a reviewed task to OmniDoer's heartbeat scheduler queue; YOLO Mode only."},
    {"id": "omnidoer_heartbeat_remove_task", "description": "Remove a task from OmniDoer's heartbeat scheduler queue; YOLO Mode only."},
    {"id": "omnidoer_heartbeat_enable", "description": "Enable OmniDoer's heartbeat scheduler; YOLO Mode only."},
    {"id": "omnidoer_heartbeat_disable", "description": "Disable OmniDoer's heartbeat scheduler; YOLO Mode only."},
    {"id": "omnidoer_heartbeat_run_once", "description": "Trigger one OmniDoer heartbeat scheduler pass; YOLO Mode only."},
    {"id": "omnidoer_browser_open", "description": "Open a reviewed URL through OmniDoer's browser bridge."},
